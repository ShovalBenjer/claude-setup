...
(the spec-discipline review found the rule unenforceable by construction while
the directory was missing). Movement stays a per-spec decision recorded in the
moving commit; nothing relocates in bulk.
