...
Generated-from-docs wiki spine (docs-control-plane rule). One PRD, one TODO, one INDEX.
...
## PRD
- [prd/claude-os.md](prd/claude-os.md) — ticketed acceptance table (SETUP-OS), 20 rows.

## Specs
- [specs/2026-07-23-persona-review-economy.md](specs/2026-07-23-persona-review-economy.md)
  — dynamic reviewer labor market (contracts, reputation, PIP, fire, recruit).
...
- Research digests (harness depth, PR-review, MCP, IVR sensors) — sourced in agent runs
  2026-07-23; key papers cited in CLAUDE-OS §2b.
