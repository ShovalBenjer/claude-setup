...
414 directories, 1826 tracked files, 0 without a stated purpose.
...
| `state/reviews` | 11 | Generated cache of 2 PR-review result JSONs keyed by commit SHA, written by the two-model review/agreement gate | registry |
