...
420 directories, 1847 tracked files, 0 without a stated purpose.
...
| `docs/analysis` | 51 | Point-in-time analysis writeups (per docs/INDEX.md heading) feeding the TODO list: stress tests, gap audits, cost/free-tier notes | registry |
...
| dir | files | purpose | from |
| --- | ----: | ------- | ---- |
| `state` | 26 | Live operational-state logs: event bus, claims/refutations/lessons jsonl, gate-runs, deploy-manifest, dangling-pointers, compact-log | registry |
