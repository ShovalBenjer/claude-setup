...
428 directories, 1917 tracked files, 0 without a stated purpose.
...
| `docs/specs/archive` | 1 | docs-control-plane rule 3: a spec whose Status turns superseded-by moves into | README.md |
