...
452 directories, 2017 tracked files, 0 without a stated purpose.
...
| `dot-claude/skills/explain-simply` | 3 | "Use when the operator asks to explain something simply or plainly, says he does not follow, or asks what is broken in plain language, before a blocker list, handoff, or report... | SKILL.md |
