...
459 directories, 2058 tracked files, 0 without a stated purpose.
...
| `docs/specs` | 31 | 4 active build specs (2026-07-23/24): autonomy implementation, command-center dashboard, persona-review economy, SLM swarm | registry |
...
| dir | files | purpose | from |
| --- | ----: | ------- | ---- |
| `state` | 33 | Live operational-state logs: event bus, claims/refutations/lessons jsonl, gate-runs, deploy-manifest, dangling-pointers, compact-log | registry |
...
| `tools/audit` | 16 | Verification tools checking whether this repo's own checks are real: a dead-pointer/hollow-hook scanner, a skills drift checker, and the mutation-testing driver reading specs fr... | registry |
