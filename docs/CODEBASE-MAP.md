...
417 directories, 1801 tracked files, 0 without a stated purpose.
...
| `docs/analysis` | 35 | Point-in-time analysis writeups (per docs/INDEX.md heading) feeding the TODO list: stress tests, gap audits, cost/free-tier notes | registry |
...
| `state/reviews` | 21 | Generated cache of 2 PR-review result JSONs keyed by commit SHA, written by the two-model review/agreement gate | registry |
