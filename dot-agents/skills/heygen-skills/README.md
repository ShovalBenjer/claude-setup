...
Works with Claude Code, Codex, Cursor, and other AI coding agents.
...
**Option C: Git clone** (legacy path):
...
- An AI agent that supports skills (Claude Code, Codex, Cursor, or similar)
