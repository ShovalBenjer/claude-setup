...
Each ships its own bundle of references so it installs cleanly via `gh skill install`, ClawHub, or direct git clone.
...
│       └── troubleshooting.md
├── platforms/                  # Platform-specific skill variants
