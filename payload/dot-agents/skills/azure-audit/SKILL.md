...
For every agent, capture: id, name, model, `created_at`. If user's AGENTS.md mentions prod agents (`seekapa`, `AxiaCS`) that are absent from the listing, flag the gap.
...
- Master plan: `~/Codex-MASTER-PLAN-2026-05-03.md`
