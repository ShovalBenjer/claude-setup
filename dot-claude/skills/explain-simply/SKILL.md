---
name: explain-simply
description: "Use when the operator asks to explain something simply, in plain or clear language, expresses confusion, or asks what is broken in plain language. Also use before any status update, decision summary, blocker list, handoff, or report a human must act on. Applies sourced plain-language rules with an executable checker that measures the draft instead of trusting it."
model: opus
---
