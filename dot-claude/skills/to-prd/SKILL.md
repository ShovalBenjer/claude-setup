---
name: to-prd
description: Turn the current conversation context into a PRD and submit it as a tracked work item (ADO or GitHub auto-detected). Use when user wants to create a PRD from the current context.
---
