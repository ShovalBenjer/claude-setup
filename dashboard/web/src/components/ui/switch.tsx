...
// Radix Switch styled to this dashboard's buzz-derived token set (see
// src/index.css); same forwardRef shape as the other web/src/components/ui
// primitives (button, badge, card), not shadcn's default switch classes.
