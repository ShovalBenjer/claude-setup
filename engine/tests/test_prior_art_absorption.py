...
sys.path.insert(0, os.path.join(ROOT, "engine", "tools", "map"))
sys.path.insert(0, os.path.join(ROOT, "engine", "tools", "audit"))
...
def records():
    base = os.path.join(ROOT, "knowledge", "docs", "prior-art")
