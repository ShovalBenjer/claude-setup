...
def repo_skills(root=None):
    return os.path.join(root or setup_root(), "payload", "dot-claude", "skills")
...
def sibling_trees(root):
    ...
    return [
        ...
        ("dot-agents", os.path.join(root, "payload", "dot-agents", "skills")),
        ("dot-codex", os.path.join(root, "payload", "dot-codex", "skills")),
    ]
...
def cmd_selftest(a):
    ...
    try:
        ...
        write_skill(os.path.join(root12, "payload", "dot-codex", "skills"), "mu", real_body())
        for n in ("mu", "nu"):
        ...
        sib = os.path.join(root12b, "payload", "dot-codex", "skills")
        ...
        write_skill(os.path.join(root12b, "payload", "dot-agents", "skills"), "rho", real_body())
